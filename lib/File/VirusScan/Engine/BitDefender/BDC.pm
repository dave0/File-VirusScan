package File::VirusScan::Engine::BitDefender::BDC;
use strict;
use warnings;
use Carp;
...
File::VirusScan::Engine::BitDefender::BDC - File::VirusScan backend for scanning with Bitdefender BDC
...
File::VirusScan::Engine::BitDefender::BDC inherits from, and follows the
