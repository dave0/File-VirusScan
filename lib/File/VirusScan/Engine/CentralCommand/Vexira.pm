package File::VirusScan::Engine::CentralCommand::Vexira;
use strict;
use warnings;
use Carp;
...
File::VirusScan::Engine::CentralCommand::Vexira - File::VirusScan backend for scanning with vexira
...
File::VirusScan::Engine::CentralCommand::Vexira inherits from, and follows the
