package File::VirusScan::Engine::CommandAntivirus;
use strict;
use warnings;
use Carp;
...
File::VirusScan::Engine::CommandAntivirus - File::VirusScan backend for scanning with Command Antivirus
...
File::VirusScan::Engine::CommandAntivirus inherits from, and follows the
