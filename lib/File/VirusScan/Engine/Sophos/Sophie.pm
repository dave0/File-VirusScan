package File::VirusScan::Engine::Sophos::Sophie;
use strict;
use warnings;
use Carp;
...
File::VirusScan::Engine::Sophos::Sophie - File::VirusScan backend for scanning with sophie
...
File::VirusScan::Engine::Sophos::Sophie inherits from, and follows the
