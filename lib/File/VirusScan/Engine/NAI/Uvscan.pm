package File::VirusScan::Engine::NAI::Uvscan;
use strict;
use warnings;
use Carp;
...
File::VirusScan::Engine::NAI::Uvscan - File::VirusScan backend for scanning with uvscan
...
File::VirusScan::Engine::NAI::Uvscan inherits from, and follows the
