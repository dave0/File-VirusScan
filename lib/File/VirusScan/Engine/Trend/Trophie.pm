package File::VirusScan::Engine::Trend::Trophie;
use strict;
use warnings;
use Carp;
...
File::VirusScan::Engine::Trend::Trophie - File::VirusScan backend for scanning with trophie
...
File::VirusScan::Engine::Trend::Trophie inherits from, and follows the
